...
class MusicRepo {
  ...
  static Future<List<Tracks>> getRegionalTracks(String region) async {
    try {
      String endpoint;
      switch (region) {
        case 'ID':
          endpoint = 'search?q=indonesia&type=track&market=ID&limit=10';
          break;
        case 'Global':
          endpoint = 'search?q=global+top+hits&type=track&limit=10';
          break;
        case 'US':
          endpoint = 'search?q=us+top+hits&type=track&market=US&limit=10';
          break;
        default:
          return [];
      }
      ...
      log('Error in getRegionalTracks: $e');
      return [];
    }
  }
